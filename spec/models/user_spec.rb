...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      addresses = %w[user@zoo,com example.user@zoo. zoo@bee_loo.com zoo@bee+loo.com user@b..ee.ru]
  ...
  describe "email adresses with mixed case" do
    let(:mixed_case_email) { "Zoo@ExAmple.CoM" }
